...
async def _process(document_id: str) -> None:
    # Create engine fresh inside this coroutine — avoids event loop
    # conflicts when asyncio.run() creates a new loop each Celery call.
    # NullPool prevents any connection reuse across calls.
